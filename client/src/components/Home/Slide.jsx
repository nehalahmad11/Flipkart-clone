...
const Slide=({products,title,timer})=>{
    ...
    const renderer=({hours,minutes,seconds})=>{
        return <Box variant="sapan">{hours}:{minutes}:{seconds} Left</Box>
    }
    return(
        <Component>
            <Deal>
                ...
                <Button variant="contained" color="primary" style={{marginLeft:"auto",backgroundColor:"rgb(40,116,240)",borderRadius:'2px',fontSize:13,fontWeight:600}}>View All</Button>
            </Deal>
            <Divider/>
